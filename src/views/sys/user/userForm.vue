<template>
  <FormWrapper ref="formWrapperRef" :title="title" :loading="loading" @after-back="afterBack">
    <template #container>
      <el-form
        ref="formRef"
        :model="model"
...
const { formWrapperRef, formRef, model, title, loading, save, open, back, afterBack } = useBaseForm(options, emit)
